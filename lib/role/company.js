...
function getCompanyList(name,unifiedBusinessNo,skip,limit,timeSort,callback) {
    console.log('======getCompanyList===name====',name)
    console.log('======getCompanyList===unifiedBusinessNo====',unifiedBusinessNo)
    console.log('======getCompanyList===skip====',skip)
    console.log('======getCompanyList===limit====',limit)
    console.log('======getCompanyList===timeSort====',timeSort)
    ...
    console.log('======getCompanyList===url====',url)
    const method = 'GET';
    const headers = {};
    httpRequest.sendGetRequest(url, headers, method, (error, body) => {
        if (error) {
