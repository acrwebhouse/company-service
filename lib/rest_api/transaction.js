exports.on = function(app) {
    ...
    app.post(preRestApi + '/applyTransaction',[middleware.tokenAuth], function(req, res) {
        /*
        #swagger.security = [{
               "apiKeyAuth": []
        }] 
    ...
    app.put(preRestApi + '/editTransactionNoIncludeCompany',[middleware.tokenAuth , middleware.checkIsEmployee], function(req, res) {
        /* #swagger.security = [{
               "apiKeyAuth": []
        }] 
        #swagger.parameters['obj'] = {
    ...
    app.delete(preRestApi + '/removeTransaction',[middleware.tokenAuth,middleware.checkIsCompanyAdmin], function(req, res) {
         /*
         #swagger.security = [{
               "apiKeyAuth": []
        }]
