    ...
    app.put(preRestApi + '/editEmployees',[middleware.checkIsCompanyAdmin], function(req, res) {
        ...
        employees.getCurrentEmployeeByUserId(userId,(result,data)=>{
            if(result == true){
                ...
                if(oldRank<rank){
                    employees.setTeamMembersManagerToAdminSmallerRank(userId,companyId,rank,(result,data)=>{
                        authAndEditEmployeesExe(id,companyId,userId,rank,managerId,state,adminId,isResign,oldState,oldIsResign,response)
                    })
                }else{
                    authAndEditEmployeesExe(id,companyId,userId,rank,managerId,state,adminId,isResign,oldState,oldIsResign,response)
                }
        ...
        function authAndEditEmployeesExe(id,companyId,userId,rank,managerId,state,adminId,isResign,oldState,oldIsResign,response){
