exports.on = function(app) {
    ...
    app.put(preRestApi + '/editEmployees',[middleware.checkIsCompanyAdmin], function(req, res) {
        ...
        console.log('===rest==editEmployees===id=',id)
        console.log('===rest==editEmployees===companyId=',companyId)
        console.log('===rest==state===state=',state)
        console.log('===rest==userId===userId=',userId)
        console.log('===rest==adminId===adminId=',adminId)
        employees.getCurrentEmployeeByUserId(userId,(result,data)=>{
            console.log('===rest==getCurrentEmployeeByUserId===id=',id)
            console.log('===rest==getCurrentEmployeeByUserId===data=',data)
            if(result == true){
    ...
    app.get(preRestApi + '/getCurrentPersonalEmployeeInfo',[middleware.tokenAuth], function(req, res) {
        /* 
       #swagger.security = [{
              "apiKeyAuth": []
       }] 
    ...
    app.get(preRestApi + '/getTeamMembers',[middleware.tokenAuth,middleware.checkIsEmployee], function(req, res) {
        /* 
        #swagger.security = [{
               "apiKeyAuth": []
        }] 
